...
class HRStaffAdvance(models.Model):
	...
	state = fields.Selection([('draft', 'Draft'),('validate', 'Confirmed'), ('paid', 'Paid')], string='State', default='draft', tracking=True)
	...
	payment_channel = fields.Selection([('bank','Bank'),('cash','Cash')], string='Payment Mode', default='bank', tracking=True)
	...
	def advance_pay(self):
		...
		for advance in self:
			...
			input_id = input_obj.create({
				...
				'employee_code': advance.employee_id.code and advance.employee_id.code or '',
				'department_id': advance.employee_id.department_id and advance.employee_id.department_id.id or False,
				'city_id': advance.employee_id.city_id and advance.employee_id.city_id.id or False,
				'branch_id': advance.employee_id.branch_id and advance.employee_id.branch_id.id or False,
				})
