...
var NameAndSignature = Widget.extend({
    template: 'aslt_ext.sign_name_and_signature',
    xmlDependencies: ['/aslt_ext/static/src/xml/name_and_signature.xml'],
    events: {
        // name
    ...
    start: function () {
        ...
        this.$payment_method = this.$('#sale_order_payment_method');
    ...
    getPaymentMethod: function () {
        return this.$payment_method.val();
    },
    /**
