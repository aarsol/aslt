...
class CustomerPortal(CustomerPortal):
    ...
    def portal_quote_accept(self, order_id, access_token=None, name=None, signature=None, payment_methods=None):
        ...
        try:
            ...
            if payment_methods and payment_methods !="":
                data_sale_order['payment_methods'] = payment_methods
            order_sudo.write(data_sale_order)
